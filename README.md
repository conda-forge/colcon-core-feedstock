...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/colcon-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/colcon-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add colcon-core
# for installing globally
pixi global install colcon-core
```
...
It is possible to list all of the versions of `colcon-core` available on your platform:
...
```
pixi search colcon-core --channel conda-forge
```
